...
# RouterOS:		6.48.3
# Device:		https://mikrotik.com/product/crs328_24p_4s_rm
# Date:			June 18, 2021
...
/system identity set name="CS-PoE_2B_MT-CRS328-24P-4S+"
...
# 010.000.099.000/24  |    99   | BASE (MGMT) VLAN
...
# set PoE settings to ensure stable intercom operation  
#######################################

  /interface ethernet
    set comment="INTERCOM_1B-EAST, forced on, high voltage"		[find name=ether1]
    set comment="INTERCOM_1B-NORD, forced on, high voltage"		[find name=ether2]  
    set comment="INTERCOM_1B-WEST, forced on, high voltage"		[find name=ether3]
    set comment="INTERCOM_GF-EAST, forced on, high voltage"		[find name=ether4]
    set comment="INTERCOM_GF-DOOR, forced on, high voltage"		[find name=ether5]   
    set comment="INTERCOM_GF-WEST, forced on, high voltage"		[find name=ether6]
    set comment="INTERCOM_1F-EAST, forced on, high voltage"		[find name=ether7]
    set comment="INTERCOM_1F-WEST, forced on, high voltage"		[find name=ether8]
    set comment="INTERCOM_2F-NORD, forced on, high voltage"		[find name=ether9]
    set comment="INTERCOM_3F-NORD, forced on, high voltage"		[find name=ether10]
    set comment="MANAGEMENT TERMINAL, LOCAL BACKUP PORT" 		[find name=ether24]
    set comment="TAGGED PORT, VLAN-TRUNK TO CORE-SWITCH-SFP" 	[find name=sfp-sfpplus1]

  /interface ethernet poe
	set  poe-voltage=high poe-out=forced-on		[find name=ether1]
	set  poe-voltage=high poe-out=forced-on	    [find name=ether2] 
	set  poe-voltage=high poe-out=forced-on	    [find name=ether3]
	set  poe-voltage=high poe-out=forced-on	    [find name=ether4]
	set  poe-voltage=high poe-out=forced-on	    [find name=ether5] 
	set  poe-voltage=high poe-out=forced-on	    [find name=ether6]
	set  poe-voltage=high poe-out=forced-on	    [find name=ether7]
	set  poe-voltage=high poe-out=forced-on	    [find name=ether8]
	set  poe-voltage=high poe-out=forced-on	    [find name=ether9]
	set  poe-voltage=high poe-out=forced-on	    [find name=ether10]
...
#######################################
  ...
  /interface bridge port
    add bridge=bridge-VLANs interface=ether1 pvid=11 ingress-filtering=yes\
	    frame-types=admit-only-untagged-and-priority-tagged comment="INTERCOM_1B-EAST, forced on, high voltage"
    add bridge=bridge-VLANs interface=ether2 pvid=11 ingress-filtering=yes\
	    frame-types=admit-only-untagged-and-priority-tagged comment="INTERCOM_1B-NORD, forced on, high voltage"
    add bridge=bridge-VLANs interface=ether3 pvid=11 ingress-filtering=yes\
	    frame-types=admit-only-untagged-and-priority-tagged comment="INTERCOM_1B-WEST, forced on, high voltage"
    add bridge=bridge-VLANs interface=ether4 pvid=11 ingress-filtering=yes\
	    frame-types=admit-only-untagged-and-priority-tagged comment="INTERCOM_GF-EAST, forced on, high voltage"
    add bridge=bridge-VLANs interface=ether5 pvid=11 ingress-filtering=yes\
	    frame-types=admit-only-untagged-and-priority-tagged comment="INTERCOM_GF-DOOR, forced on, high voltage"
    add bridge=bridge-VLANs interface=ether6 pvid=11 ingress-filtering=yes\
	    frame-types=admit-only-untagged-and-priority-tagged comment="INTERCOM_GF-WEST, forced on, high voltage"
    add bridge=bridge-VLANs interface=ether7 pvid=11 ingress-filtering=yes\
	    frame-types=admit-only-untagged-and-priority-tagged comment="INTERCOM_1F-EAST, forced on, high voltage"
    add bridge=bridge-VLANs interface=ether8 pvid=11 ingress-filtering=yes\
	    frame-types=admit-only-untagged-and-priority-tagged comment="INTERCOM_1F-WEST, forced on, high voltage"
    add bridge=bridge-VLANs interface=ether9 pvid=11 ingress-filtering=yes\
	    frame-types=admit-only-untagged-and-priority-tagged comment="INTERCOM_2F-NORD, forced on, high voltage"
    add bridge=bridge-VLANs interface=ether10 pvid=11 ingress-filtering=yes\
	    frame-types=admit-only-untagged-and-priority-tagged comment="INTERCOM_3F-NORD, forced on, high voltage"
    add bridge=bridge-VLANs interface=ether24 pvid=99 ingress-filtering=yes\
...
#######################################
  ...
  /interface bridge port
	add bridge=bridge-VLANs interface=sfp-sfpplus2 	comment="TAGGED PORT, VLAN-TRUNK TO CORE-SWITCH-SFP"  	                                                        	
	
  # add VLANs to be allowed on the tagged ports Only these will be trunked through the connected wire
  /interface bridge vlan
    add bridge=bridge-VLANs vlan-ids=1	 comment="BLACKHOLE"  		 			tagged=sfp-sfpplus2
	add bridge=bridge-VLANs vlan-ids=2	 comment="PRINTERS"  					tagged=sfp-sfpplus2
	add bridge=bridge-VLANs vlan-ids=11	 comment="IoT_INTERCOM"  				tagged=sfp-sfpplus2
	add bridge=bridge-VLANs vlan-ids=99	 comment="BASE (MGMT) VLAN"  			tagged=sfp-sfpplus2,bridge-VLANs
	add bridge=bridge-VLANs vlan-ids=111 comment="MAIN VLAN OF USER1 FOR WLAN" 	tagged=sfp-sfpplus2
	add bridge=bridge-VLANs vlan-ids=121 comment="MAIN VLAN OF USER2 FOR WLAN" 	tagged=sfp-sfpplus2      
	add bridge=bridge-VLANs vlan-ids=131 comment="MAIN VLAN OF USER3 FOR WLAN" 	tagged=sfp-sfpplus2      
	add bridge=bridge-VLANs vlan-ids=141 comment="MAIN VLAN OF USER4 FOR WLAN" 	tagged=sfp-sfpplus2      
	add bridge=bridge-VLANs vlan-ids=151 comment="MAIN VLAN OF USER5 FOR WLAN" 	tagged=sfp-sfpplus2
	add bridge=bridge-VLANs vlan-ids=161 comment="MAIN VLAN OF USER6 FOR WLAN" 	tagged=sfp-sfpplus2      
	add bridge=bridge-VLANs vlan-ids=171 comment="MAIN VLAN OF USER7 FOR WLAN" 	tagged=sfp-sfpplus2      
	add bridge=bridge-VLANs vlan-ids=181 comment="MAIN VLAN OF USER8 FOR WLAN" 	tagged=sfp-sfpplus2      
	add bridge=bridge-VLANs vlan-ids=200 comment="GUEST LAN"  					tagged=sfp-sfpplus2
	add bridge=bridge-VLANs vlan-ids=201 comment="GUEST WLAN"  					tagged=sfp-sfpplus2
	add bridge=bridge-VLANs vlan-ids=301 comment="DMZ - NAS(s)"  				tagged=sfp-sfpplus2
	add bridge=bridge-VLANs vlan-ids=401 comment="LAB"  						tagged=sfp-sfpplus2
...
#######################################
  ...
  /ip address  
	add address=10.99.99.3/24 	interface=VLAN_099	comment="BASE (MGMT) VLAN"
