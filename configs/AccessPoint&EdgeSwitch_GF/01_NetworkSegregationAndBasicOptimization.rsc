...
#######################################
 ...
 /interface ethernet
   ...
   set comment="USER3, DINING ROOM"								[find name=ether2]  
...
#######################################
  ...
  /interface bridge port
    add bridge=bridge-VLANs interface=ether2 pvid=130 ingress-filtering=yes\
	    frame-types=admit-only-untagged-and-priority-tagged comment="USER3, DINING ROOM"
...
#######################################
  ...
  /interface bridge vlan
	...
	add bridge=bridge-VLANs vlan-ids=130 comment="MAIN VLAN OF USER3 FOR LAN" 	tagged=ether1
...
#######################################
  ...
  /ip address  
	add address=10.99.99.103/24 	interface=VLAN_099	 comment="BASE (MGMT) VLAN"
