...
# RouterOS:		6.48.3
# Device:		https://mikrotik.com/product/crs328_4c_20s_4s_rm
# Date:			June 18, 2021
...
/system identity set name="CS-SFP_2B_MT-CRS328-4C-20S-4S+"
...
#######################################
  ...
  /interface ethernet
    set comment="TAGGED PORT, VLAN-TRUNK TO ES_USER1" 		[find name=sfp1]
    set comment="TAGGED PORT, VLAN-TRUNK TO ES_USER2" 		[find name=sfp2]
    set comment="TAGGED PORT, VLAN-TRUNK TO ES_USER3" 		[find name=sfp3]
    set comment="TAGGED PORT, VLAN-TRUNK TO ES_USER4" 		[find name=sfp4]
    set comment="TAGGED PORT, VLAN-TRUNK TO ES_USER5" 		[find name=sfp5]
    set comment="TAGGED PORT, VLAN-TRUNK TO ES_USER6" 		[find name=sfp6]
    set comment="TAGGED PORT, VLAN-TRUNK TO ES_USER7" 		[find name=sfp7]
    set comment="TAGGED PORT, VLAN-TRUNK TO ES_USER8" 		[find name=sfp8]
    set comment="TAGGED PORT, VLAN-TRUNK TO ES_PoE-To-APs" 	[find name=sfp10]
    set comment="MANAGEMENT TERMINAL, LOCAL BACKUP PORT" 	[find name=combo4]
    set comment="TAGGED PORT, VLAN-TRUNK TO CORE-SWITCH-PoE" [find name=sfp-sfpplus1]
    set comment="TAGGED PORT, VLAN-TRUNK TO CORE-ROUTER" 	[find name=sfp-sfpplus2]
...
#######################################
  ...
  /interface bridge port
    add bridge=bridge-VLANs interface=combo4 pvid=99 ingress-filtering=yes\
...
#######################################
  ...
  /interface bridge port
    add bridge=bridge-VLANs interface=sfp1			comment="TAGGED PORT, VLAN-TRUNK TO ES_USER1" 		
	add bridge=bridge-VLANs interface=sfp2			comment="TAGGED PORT, VLAN-TRUNK TO ES_USER2" 		
	add bridge=bridge-VLANs interface=sfp3			comment="TAGGED PORT, VLAN-TRUNK TO ES_USER3" 		
	add bridge=bridge-VLANs interface=sfp4			comment="TAGGED PORT, VLAN-TRUNK TO ES_USER4" 		
	add bridge=bridge-VLANs interface=sfp5			comment="TAGGED PORT, VLAN-TRUNK TO ES_USER5" 		
    add bridge=bridge-VLANs interface=sfp6			comment="TAGGED PORT, VLAN-TRUNK TO ES_USER6" 		
	add bridge=bridge-VLANs interface=sfp7			comment="TAGGED PORT, VLAN-TRUNK TO ES_USER7" 		
	add bridge=bridge-VLANs interface=sfp8			comment="TAGGED PORT, VLAN-TRUNK TO ES_USER8" 		
	add bridge=bridge-VLANs interface=sfp10			comment="TAGGED PORT, VLAN-TRUNK TO ES_PoE-To-APs" 	
	add bridge=bridge-VLANs interface=sfp-sfpplus1 	comment="TAGGED PORT, VLAN-TRUNK TO CORE-SWITCH-PoE"  	
    add bridge=bridge-VLANs interface=sfp-sfpplus2	comment="TAGGED PORT, VLAN-TRUNK TO CORE-ROUTER"
	
  # add VLANs to be allowed on the tagged ports Only these will be trunked through the connected wire
  /interface bridge vlan
    add bridge=bridge-VLANs vlan-ids=1 comment="BLACKHOLE"  		 			tagged=sfp-sfpplus2,sfp-sfpplus1            
	add bridge=bridge-VLANs vlan-ids=2 comment="PRINTERS"  						tagged=sfp-sfpplus2,sfp-sfpplus1      
	add bridge=bridge-VLANs vlan-ids=11 comment="IoT_INTERCOM"  				tagged=sfp-sfpplus2,sfp-sfpplus1            
	add bridge=bridge-VLANs vlan-ids=99 comment="BASE (MGMT) VLAN"  			tagged=sfp-sfpplus2,sfp-sfpplus1,sfp1,sfp2,sfp3,sfp4,sfp5,sfp6,sfp7,sfp8,sfp10,bridge-VLANs
	add bridge=bridge-VLANs vlan-ids=110 comment="MAIN VLAN OF USER1 FOR LAN" 	tagged=sfp-sfpplus2,sfp1
	add bridge=bridge-VLANs vlan-ids=111 comment="MAIN VLAN OF USER1 FOR WLAN" 	tagged=sfp-sfpplus2,sfp1,sfp2,sfp3,sfp4,sfp5,sfp6,sfp7,sfp8,sfp10
	add bridge=bridge-VLANs vlan-ids=120 comment="MAIN VLAN OF USER2 FOR LAN" 	tagged=sfp-sfpplus2,sfp2
	add bridge=bridge-VLANs vlan-ids=121 comment="MAIN VLAN OF USER2 FOR WLAN" 	tagged=sfp-sfpplus2,sfp1,sfp2,sfp3,sfp4,sfp5,sfp6,sfp7,sfp8,sfp10      
	add bridge=bridge-VLANs vlan-ids=130 comment="MAIN VLAN OF USER3 FOR LAN" 	tagged=sfp-sfpplus2,sfp3,sfp10      
	add bridge=bridge-VLANs vlan-ids=131 comment="MAIN VLAN OF USER3 FOR WLAN" 	tagged=sfp-sfpplus2,sfp1,sfp2,sfp3,sfp4,sfp5,sfp6,sfp7,sfp8,sfp10      
	add bridge=bridge-VLANs vlan-ids=140 comment="MAIN VLAN OF USER4 FOR LAN" 	tagged=sfp-sfpplus2,sfp4
	add bridge=bridge-VLANs vlan-ids=141 comment="MAIN VLAN OF USER4 FOR WLAN" 	tagged=sfp-sfpplus2,sfp1,sfp2,sfp3,sfp4,sfp5,sfp6,sfp7,sfp8,sfp10      
	add bridge=bridge-VLANs vlan-ids=150 comment="MAIN VLAN OF USER5 FOR LAN" 	tagged=sfp-sfpplus2,sfp5
	add bridge=bridge-VLANs vlan-ids=151 comment="MAIN VLAN OF USER5 FOR WLAN" 	tagged=sfp-sfpplus2,sfp1,sfp2,sfp3,sfp4,sfp5,sfp6,sfp7,sfp8,sfp10
	add bridge=bridge-VLANs vlan-ids=160 comment="MAIN VLAN OF USER6 FOR LAN" 	tagged=sfp-sfpplus2,sfp6,sfp10
	add bridge=bridge-VLANs vlan-ids=161 comment="MAIN VLAN OF USER6 FOR WLAN" 	tagged=sfp-sfpplus2,sfp1,sfp2,sfp3,sfp4,sfp5,sfp6,sfp7,sfp8,sfp10      
	add bridge=bridge-VLANs vlan-ids=170 comment="MAIN VLAN OF USER7 FOR LAN" 	tagged=sfp-sfpplus2,sfp7
	add bridge=bridge-VLANs vlan-ids=171 comment="MAIN VLAN OF USER7 FOR WLAN" 	tagged=sfp-sfpplus2,sfp1,sfp2,sfp3,sfp4,sfp5,sfp6,sfp7,sfp8,sfp10      
	add bridge=bridge-VLANs vlan-ids=180 comment="MAIN VLAN OF USER8 FOR LAN" 	tagged=sfp-sfpplus2,sfp8
	add bridge=bridge-VLANs vlan-ids=181 comment="MAIN VLAN OF USER8 FOR WLAN" 	tagged=sfp-sfpplus2,sfp1,sfp2,sfp3,sfp4,sfp5,sfp6,sfp7,sfp8,sfp10      
	add bridge=bridge-VLANs vlan-ids=200 comment="GUEST LAN"  					tagged=sfp-sfpplus2,sfp-sfpplus1,sfp1,sfp2,sfp3,sfp4,sfp5,sfp6,sfp7,sfp8,sfp10
	add bridge=bridge-VLANs vlan-ids=201 comment="GUEST WLAN"  					tagged=sfp-sfpplus2,sfp-sfpplus1,sfp1,sfp2,sfp3,sfp4,sfp5,sfp6,sfp7,sfp8,sfp10
	add bridge=bridge-VLANs vlan-ids=301 comment="DMZ - NAS(s)"  				tagged=sfp-sfpplus2,sfp-sfpplus1
	add bridge=bridge-VLANs vlan-ids=401 comment="LAB"  						tagged=sfp-sfpplus2,sfp-sfpplus1          
...
#######################################
  ...
  /ip address  
	add address=10.99.99.2/24 	interface=VLAN_099	comment="BASE (MGMT) VLAN"
